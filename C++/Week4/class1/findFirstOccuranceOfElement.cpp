...
// target = 4;
// output : first occurance of 4 is at 3rd index
...
int takeTagetKey(){
     int key;
     cout<<"Enter the Element Value of which you want to know the first Occurance : ";
     cin>>key;
     return key;
}
...
int main()
{
    ...
    cout<<"First Occurance Index Value of Element "<<key<<" is : "<<indexOfTarget<<endl;
    }
}